...
@section('title', 'All Authors - ' . config('app.name'))
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>@sortablelink('patronymic', 'Patronymic')</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @forelse ($authors as $author)
                                        <tr>
                                        <td class="text-center">{{ $loop->index + $authors->firstItem() }}</td>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center">
                                                    <a href="{{ route("dashboard.authors.edit", $author->id) }}" class="btn btn-warning mr-1">Edit</a>
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="6" class="text-center">No author found!</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
