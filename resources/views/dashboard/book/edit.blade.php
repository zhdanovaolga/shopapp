                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route("dashboard.books.update", $book->id) }}" enctype="multipart/form-data" method="POST">
                                @csrf
                                @method("PUT")
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="description" name="description" placeholder="Write decription" value="{{ $book->description }}"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="price">Price</label>
                                            <input type="text" class="form-control" id="price" name="price" placeholder="Write price" value="{{ $book->price }}"/>
                                        </div>
                                        <div class="form-group">
                                            <label for="release_date">Publish Year</label>
                                            <input type="text" class="form-control" id="publish_year" name="publish_year"placeholder="Write year" value="{{ $book->publish_year }}"/>
                                        </div>
                                    </div>
                                    <div class="col-md-4 mx-auto">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control"  src="{{ asset("uploads/category/".$book->image) }}" id="image" name="image" accept="image/*"/>
